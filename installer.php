...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210509_pizzaplena_540525d0a3f3ca9a4529_20210509225542_archive.zip';
	const ARCHIVE_SIZE		 = '88715851';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '540525d-09225542';
    const SECONDARY_PACKAGE_HASH = 'db81492-09225542';
	const VERSION			 = '1.4.0';
